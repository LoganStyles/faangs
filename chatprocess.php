			...
			if($fil!=""){
				...
				// if everything is ok, try to upload file
				...
				else 
					{
						...
						{
							$fname=$newfilename;
									$query=" INSERT into  home(username,post_content,image,date,time,category,sta)
										VALUES
										('$sessionvariable','$post','$fname','$dat','$tim','fashion',1)";
										$k=mysql_query($query);
									if ($k)
								{
				...
				$query=" INSERT into  home(username,post_content,image,date,time,category,sta)
										VALUES
										('$sessionvariable','$post','','$dat','$tim','fashion',0)";
										$k=mysql_query($query);
									if ($k)
								{
									$nam=" has been succesfully added to the social media content</H4>";

											...
											if(mysql_num_rows($result1)>0)
												{
													while($rec=mysql_fetch_array($result1)){
														if($rec["state"]==1){
														 echo "<a href=\"noti2.php?id={$rec['id']}\"><div style=\"height:50px;margin-bottom:1px;background:#f4e1d2;line-height:3;\">";
														}
														else{
														 echo "<a href=\"noti2.php?id={$rec['id']}\"><div style=\"height:50px;margin-bottom:1px;background:white;line-height:3;\">";	
														}

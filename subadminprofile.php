...
<div class="col-md-12 t">
    <h3 style="margin-top:100px;TEXT-ALIGN:CENTER;"><?php echo "{$res['username']}'s privilages"; ?></h3>
    <!----------------------------------------------------div body---------------------------------------------------->				
...
echo"		  <label><input type=\"checkbox\" value=\"\" name=\"view_contestant\" $d3>View Contestant</label>
											</div>
											<div class=\"checkbox col-md-5 col-md-offset-2\">";
...
echo"		  <label><input type=\"checkbox\" value=\"\" name=\"uuser\" $d4>Update User date</label>
											</div>
											<div class=\"checkbox col-md-5 col-md-offset-2\">";
